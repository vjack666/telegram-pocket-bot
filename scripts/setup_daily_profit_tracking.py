"""
ACTIVACIÓN: Daily Profit Tracking

Cómo activar y configurar el tracking de meta diaria de $60
"""
...
if __name__ == "__main__":
    ...
    config_file = Path(__file__).parent.parent / "docs" / "DAILY_PROFIT_TRACKING_CONFIG.md"
    config_file.parent.mkdir(parents=True, exist_ok=True)
    config_file.write_text(CONFIG_INSTRUCTIONS, encoding="utf-8")
    print(f"\n✓ Configuración guardada en: {config_file.relative_to(Path.cwd())}")
